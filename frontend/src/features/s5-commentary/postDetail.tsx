...
export function PostDetail() {
  ...
  switch (state.status) {
    ...
    case "not_found":
      return (
        <div
          className="max-w-xl mx-auto mt-10 bg-white rounded-2xl shadow-lg p-6 text-center text-gray-600"
          role="alert"
        >
    ...
    case "error":
      return (
        <div
          className="max-w-xl mx-auto mt-10 bg-red-50 text-red-700 rounded-2xl shadow p-6 text-center"
          role="alert"
        >
          {state.message}
        </div>
